...
const AlertWindow = ({ remaining }: AlertWindowProps) => {
  return (
    <div className="absolute max-w-[810px] top-0 left-[50%] py-[6px] px-[9px] sm:py-[12px] sm:px-[13px] lg:py-[18px] lg:px-[26px] 2xl:py-[24px] 2xl:px-[36.5px] translate-x-[-50%] bg-white border-x-[3px] border-b-[3px] rounded-b-3xl border-[#D93284] z-[20]">
