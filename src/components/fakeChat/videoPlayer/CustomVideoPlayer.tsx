  ...
  return (
    <div>
      ...
      <div className="absolute w-screen h-screen flex items-center justify-center">
        <div
          className={`flex flex-col cursor-pointer items-center justify-center lg:relative lg:w-[70%] absolute rounded-[1.5vw] w-[55vw] top-0  overflow-hidden group/item  z-[21]`}
        >
          <Video
            autoPlay={autoPlay}
            muted={muted}
