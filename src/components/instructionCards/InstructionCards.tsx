    ...
    <>
      ...
      <main>
        {!backToPanorama && (
          <>
            <div
              className="absolute w-[100vw] h-[100vh] z-[2] bg-[#42424299]/[0.6]"
              onClick={changeVisibleInstruction}
            ></div>
                  ...
                  <div className="flex gap-[3px] py-[5px] md:py-[8px] 2xl:py-[10px] 2xl:gap-[5px]">
                    {buttonsData.map((btn) => (
                      <div
                        ...
                        onClick={() => {
                          setCardID(btn);
                          setCurrentIndex(parseInt(btn) - 1);
                        }}
                        className={`${
                          btn === cardID
                            ? "w-[20px] md:w-[24px] 2xl:w-[32px] opacity-100"
                            : "w-[8px] md:w-[10px] 2xl:w-[14px] opacity-50 cursor-pointer"
                ...
                >
                  ...
                  hover:bg-[#F060C0] active:bg-[#792EC0]"
                    onClick={
                      !(currentIndex == 3)
                        ? goToNextCard
                        : changeVisibleInstruction
                    }
                  >
                    {!(currentIndex == 3) ? "далее" : "начать"}
                  </button>
                </div>
              </div>
            </div>
