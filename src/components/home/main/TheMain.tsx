...
export const TheMain = () => {
  return (
    <main className="relative flex flex-col justify-center items-center text-center uppercase h-[calc(100dvh-13dvh)] md:h-[calc(100dvh-18dvh)]">
      <h1
      ...
      <div className="relative w-[3.91dvw]">
        <div className={`rounded-full ${styles.gradient} blur-[3px]`}></div>
        <Image
          className="absolute w-[3.7dvw] h-[10.2dvh] top-[40%] left-[9%]"
          src={"/pointer.svg"}
          alt={"Указатель"}
          width={70}
          height={110}
